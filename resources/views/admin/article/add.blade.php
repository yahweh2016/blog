            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <input type="hidden" name="art_thumb" id="file_uploads">
                            <img src="" name="art_thumb" style="max-height: 100px;max-width: 100px;display:none" id="art_thumb"/>
                        </td>
                    </tr>
                    {{--<tr>--}}
                        {{--<th>复选框：</th>--}}
                    ...
                    <tr>
                        <th>详细内容：</th>
                        <td>
                            <script id="editor" type="text/plain" style="width:1024px;height:500px;" name="art_content"></script>
                            <script>
