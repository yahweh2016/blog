...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('/admin/info')}}">首页</a> &raquo; 系统信息展示
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <ul>
            ...
            <li>
                <label>天使设计-版本</label><span>v-0.2</span>
            </li>
            <li>
                <label>上传附件限制</label><span><?php echo ini_get('upload_max_filesize')?></span>
            </li>
            <li>
                <label>北京时间</label><span>{{date('Y年m月d日H时i分s秒')}}</span>
            </li>
            <li>
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <ul>
            <li>
                <label>官方交流网站：</label><span><a href="#">http://buyplus.com</a></span>
            </li>
            <li>
