...
<div class="result_wrap">
    ...
    <div class="result_content">
        <div class="short_wrap">
            ...
            <a href="{{url('admin/category')}}"><i class="fa fa-list"></i>全部分类</a>
        </div>
    </div>
</div>
<!--结果集标题与导航组件 结束-->
    ...
    <form action="{{url('admin/article/'.$cate['cate_id'])}}" method="post">
        ...
        <table class="add_tab">
                ...
                <td>
                    <select name="cate_pid">
                        ...
                        @foreach($data as $value)
                            <option value="{{$value['cate_id']}}" @if($cate['cate_pid']==$value['cate_id']) selected @endif>{{$value['cate_name']}}</option>
                        @endforeach
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <th>关键词：</th>
                <td>
                    <textarea class="lg" name="cate_keywords">{{$cate['cate_keywords']}}</textarea>
                </td>
            </tr>
            <tr>
